...
proctype P1() {
	...
	atomic {
		if
		::D0_7?1
		:: (empty(D0_7) && nempty(D0_15)) -> D0_15?1
	...
	atomic {
		if
		:: D0_0?1
		:: (empty(D0_0) && nempty(D0_14)) -> D0_14?1
		fi
	};
	atomic {
		D0_15?1
	...
	atomic {
		...
		:: D0_0?1
		:: (empty(D0_0) && nempty(D0_14)) -> D0_14?1
		:: (empty(D0_14) && nempty(D0_18)) -> D0_18?1
		fi
	}
}
...
proctype P2() {
	...
	atomic {
		if
		::D0_8?1
		:: (empty(D0_8) && nempty(D0_17)) -> D0_17?1
	...
	atomic {
		if
		:: D0_1?1
		:: (empty(D0_1) && nempty(D0_16)) -> D0_16?1
		fi
	};
	atomic {
		D0_17?1
	...
	atomic {
		...
		:: D0_1?1
		:: (empty(D0_1) && nempty(D0_16)) -> D0_16?1
		:: (empty(D0_16) && nempty(D0_19)) -> D0_19?1
		fi
	}
}
...
proctype P3() {
	...
	atomic {
		if
		:: D0_2?1
		:: (empty(D0_2) && nempty(D0_20)) -> D0_20?1
		fi
	}
}
...
proctype P4() {
	...
	atomic {
		if
		:: D0_3?1
		:: (empty(D0_3) && nempty(D0_21)) -> D0_21?1
		fi
	}
}
...
proctype P5() {
	...
	atomic {
		if
		:: D0_4?1
		:: (empty(D0_4) && nempty(D0_22)) -> D0_22?1
		fi
	}
}
...
proctype P6() {
	...
	atomic {
		if
		:: D0_5?1
		:: (empty(D0_5) && nempty(D0_23)) -> D0_23?1
		fi
	}
}
...
proctype P7() {
	...
	atomic {
		if
		:: D0_6?1
		:: (empty(D0_6) && nempty(D0_24)) -> D0_24?1
		fi
	}
}
